...
//   | { type: typeof ACTION.PUSH }
//   | { type: typeof ACTION.UNSHIFT }
//   | { type: typeof ACTION.REPLACE }
...
// function uuseArray<T>(initialValue: T[] = []) {
//   const [state, dispatch] = useReducer(reducer, { array: 0 })
// }
